...
contract VRFCoordinatorV2Mock is VRFCoordinatorV2Interface {
   ...
   */
  function rawFulfillRandomness(uint256 _requestId, address _consumer) external {
    ...
    VRFConsumerBase v;
    bytes memory callReq = abi.encodeWithSelector(v.rawFulfillRandomness.selector, _requestId, words);
